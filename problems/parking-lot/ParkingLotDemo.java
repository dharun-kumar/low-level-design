...
public class ParkingLotDemo {
    ...
    public static void main() throws InterruptedException {
        ...
        parkingLot.setCapacity(1, 2, 5, 1);

        Vehicle car1 = new Car("TN 88 AB 1234");
        Optional<ParkingTicket> car1Ticket = parkingLot.checkIn(car1);
        ...
        Optional<ParkingTicket> car2Ticket = parkingLot.checkIn(car2);
        ...
        Optional<ParkingTicket> car3Ticket = parkingLot.checkIn(car3);
        ...
        if(car1Ticket.isPresent()) {
            parkingLot.checkOut(car1Ticket.get());
        ...
        car3Ticket = parkingLot.checkIn(car3);
        car3Ticket.ifPresent(ticket -> System.out.println("Vehicle " + ticket.getVehicle().getVehicleNumber() + " parked in floor " + ticket.getParkedFloor()));
